...
// MAXVAL must be relatively small here, because pigeonholeSort needs to
// make one bucket for each value 0 .. MAXVAL.


// pigeonholeSort
// Sorts a sequence of nonnegative ints, using Pigeonhole Sort.
// Requirements on Types:
//     FDIter is be a forward iterator type.
//     FDIter must have value type int.
// Pre:
//     [first, last) is a valid range.
//     Each item in [first, last) is in range 0..MAXVAL.
//     1+MAXVAL is a legal size for a vector<int>.

...
// Number of digits in values in our dataset. This needs to be
// consistent with MAXVAL, above. (Alas, we're not being as DRY as we
// could be.)
const int NUM_PLACES = 9;


// radixSort
// Sorts a sequence of 9-digit nonnegative ints, using Radix Sort.
// Global value NUM_PLACES is the number of passes to do.

...
// Same Binary Search function, but called on std::list, not std::vector
...
void tryBinSearch(const list<bignum> & data,  // Data to search in
...
int main()
{
    ...
    list<bignum> data;
    //data.reserve(SIZE);  // std::list does not have this
    ...
    const list<pair<bignum, bool>> searchfor {
